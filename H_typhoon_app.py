...
from H_pandas_app import PandasAgent
...
class TyphoonAgent:
    ...
    def query_dataframe(self, user_input: str) -> None:
        ...
        """
        return self.pandas_agent.run(user_input, self.dataset_key)
...
if __name__ == "__main__":
    ...
    agent = TyphoonAgent(
        ...
        dataset_key='Financials.csv'

    )
    agent.run(user_input='show df info')
